...
// This is a media-understanding contract id, not a text model-provider namespace.
const CODEX_MEDIA_UNDERSTANDING_PROVIDER_ID = "codex";
...
export function buildCodexMediaUnderstandingProvider(
  ...
  return {
    id: CODEX_MEDIA_UNDERSTANDING_PROVIDER_ID,
    capabilities: ["image"],
